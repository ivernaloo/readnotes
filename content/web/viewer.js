...
document.addEventListener('DOMContentLoaded', function webViewerLoad(evt) {
  ...
  var sure_to_zoom = 'Attention! Zooming will cause the page to refresh and lose what you have marked. Are you sure?'
  var zoom_alert = function(){
	return $('[remarkalbe]').length ? confirm(sure_to_zoom) : true;
  }
  document.getElementById('zoomIn').addEventListener('click',
    function() {
	  zoom_alert() && PDFView.zoomIn();
    });

  document.getElementById('zoomOut').addEventListener('click',
    function() {
      zoom_alert() && PDFView.zoomOut();
    });
  ...
  document.getElementById('scaleSelect').addEventListener('change',
    function() {
      zoom_alert() && PDFView.parseScale(this.value);
    });
